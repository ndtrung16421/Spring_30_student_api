...
<!-- <div class="card-body">
	<div class="row">
		...
		<div class="col-sm-3 form-check">
			...
			<input type="radio" id="male" value="M" class="form-check-input"><label
				for="male" class="form-check-label">Male</label><br>
			<input type="radio" id="female" value="F" class="form-check-input"><label
				for="female" class="form-check-label">Female</label><br>
			<input type="radio" id="all" value="" class="form-check-input"><label
				for="all">All</label><br>
		</div>
		<div class="col col-12">
			<div
				class="v-input v-input--is-label-active v-input--is-dirty v-input--dense theme--light v-text-field v-text-field--is-booted v-select">
				<div class="v-input__control">
					<div role="button" aria-haspopup="listbox" aria-expanded="false"
						aria-owns="list-86" class="v-input__slot">
						<div class="v-select__slot">
							<label for="input-86"
								class="v-label v-label--active theme--light"
								style="left: 0px; right: auto; position: absolute;">Pick
								a Team</label>
							<div class="v-select__selections">
								<div class="v-select__selection v-select__selection--comma"></div>
								<input id="input-86" readonly="readonly" type="text"
